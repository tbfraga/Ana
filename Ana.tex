...
\chapter{A escada de Penrouse e a indústria da loucura}

\noindent Ontem, exatamente, partindo do momento e que me proponho a escrever ...

\noindent \begin{center} \emph{Mais uma pessoa me confessou ter sido diagnosticada com síndrome do pânico. } \end{center}

\noindent Isso acontece, porque uma pessoa é sempre disposta a se abrir quando entende que isso não lhe oferece nenhum risco... em especial quando é algo tão fora da caixa e de díficil compreensão e aceitação. É necessário falar sobre isso com alguém que é capaz de compreender. \\

\noindent Nesse caso, precisamente, os psicólogos e psiquiatras deixam de ser adequados. \\

\noindent Mas a confição não é sobre qualquer sídrome. Surge após alguns minutos de conversa: eu não estou doente, eu também estou sendo aterrorizado. \\ 

\noindent E a minha resposta é precisa: é claro que você não está doente. Mas é claro que qualquer médico ordinário iria te apresentar este mesmo veredicto. \\

\noindent Dias atrás eu estava tentando me lembrar sobre o nome e a história daquela escada que nunca termina. \\
