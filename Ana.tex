...
\noindent After a long search, I found out that companies and research groups are working with the development of BCI (brain - computer interfaces). And that this technology is already being used. \\
...
\noindent So, basead on my own experiences, I will tell about my conclusions about The Schema currupt people are using for data collection. \\

\noindent  ... \\

the schema: o experimento \\

\noindent Como seria possível usar alguma nova tenologia para levantamento de dados em seres humanos, sem que as pessoas se rebelem sobre o que está acontecendo ? \\

\noindent Afinal, há efeitos colaterais, como dores, tontura, reações não desejadas do organismo, etc. \\

\noindent Então me parece que justificar tudo isso com uma pandemia é uma boa opção. Por que não ? Ademais as vacinas são o meio mais eficaz de injetar qualquer porcaria em um grupo de pessoas. \\

\noindent Pademia - pânico - vacinas - nanotecnologia - simulações - desenvolvimento de novas tecnologias (novos materiais, inteligências artificias, novos medicamentos, novos pré-bioticos, diversas novas informações sobre céluals e enzimas, robôs fazendo piruetas, drones insetos, etc) - entendeu ou preciso desenhar ? \\ 

\noindent Mas vou deixar um pouco de lado o aspecto global do problema e vou começar explicando uma outra forma de conseguir usar seres humanos (pessoas) para testes científicos e levantamento de dados sem que estas pessoas possam reclamar seus direitos. \\

the schema: a indústria da loucura \\

\noindent Em 20XX, o então presidente do Brasil, Jair Messias Bolsonaro, assina um decreto permitindo a instituicionalização de pessoa entendidas com possuiodoras de transtornos mentais em clínicas particulares. (incluir dados e referências). \\

\noindent Então, rapidamente surgem vários novos hospitais psiquiatricos particulares e uma imensa quantidade de pessoas são entendidas como portadoras de algum tipo grave de deficiência mental e são "internadas". \\

\noindent Sério, vou repetir: Bolsonaro assina decreto permitindo internação em hospitais psiquiatricos particulares - pessoas, antes normais, começam a enlouquecer e são levadas para clínicas psiquiatricas - involuntariamente, preciso dizer, e são institucionalizadas. \\

\noindent Eu não estou inventando. Isso está mesmo acontecendo no Brasil. Em julho de 2024 ainda está acontecendo. \\

\noindent Ministérios públicos, mais especificamente Ministérios da Saúde (acredito que estaduais), estão simplesmente autorizando as internações. \\

\noindent Eu tive o desprazer de ler uma reportagem falando sobre o caso do Estado do Rio de Janeiro, onde .... \\

\noindent Uma vez que a pessoa e entendida como portadora de um problema mental que justifica a internação, isto é usado contra a pessoa. A pessoa não consegue nenhum tipo de suporte. Porque, afinal, a pessoa é tida como doente mental. Está fora da realidade. \\

\noindent O próprio ministério público irá trabalhar no sentido de que a pessoa seja realmente identificada como doente mental. \\

\noindent Espera aí: o ministério público não é um órgão que deveria agir no sentido de proteger as pessoas ? Pois esta é exatamente a justificativa utilizada para permitir este grande abuso. Drogados e doentes mentais representam uma grande pertubação para a sociedade, não é mesmo ? Ou quem sabe apenas alguma desculpa higienista. \\

\noindent Depois de minha internação e das agressões que comecei a sofrer a partir do final do ano 2021, eu tentei ajuda em todos os orgão públicos que oferem apoio à pessoas que são vítimas de violência. Eu fui inúmeras vezes a delecias de polícia. Fui em várias delegacias de polícia diferentes. Eu procurei ajuda nas agências Maria da Penha. Eu repeti inúmeras vezes, para várias partes supostamente interessadas, que eu estava sendo aterrorizada. \\

\noindent No final, logo após o furto de meu gatinho que tinha apenas 30 dias, a policia me pediu para assinar um termo de colaboração (ou alguma coisa assim) sem data, no qual eu permitia apresentar informações ao Ministério Público. Posteriormente a isso, eu estive no próprio ministério público. E o que este orgão fez ? Abriram uma pasta com meu nome. \\ 

\noindent Eu pedi cópia do documento que eu assinei na delegacia de polícia. O documento sumiu. Se eu quiser acesso aos documentos da pasta que abriram com o meu nome, eu preciso contratar um advogado. Eu preciso entrar com um processo na justiça para ter direito à saber se o Ministério Público do Estado do Rio de Janeiro assinou a minha internação involuntária. Sem ter qualquer informação sobre mim. Sem que sequer eu estivesse morando no estado do Rio de Janeiro. Qualquer coisa que eu queira saber, eu preciso entrar com um processo na justiça. \\

\noindent Em resumo. Isso é autorizado, normatizado, regularizado. É alguma coisa que vem dos próprios Ministérios Públicos. Alguma coisa que se iniciou (nesta escala) durante o governo de Bolsonaro. Preciso dizer: em tempos de COVID. \\

\noindent Levando em conta a morosidade da justiça no Brasil. Além de ter que dispôr de uma enorme quantia de dinheiro e tempo, processos judiciais não levam a lugar algum a curto prazo. Muitos processos ficam simplesmente parados. \\

\noindent Todo e qualquer esforço no sentido de autodefesa leva a um único fim. A exaustão.\\

\noindent Então, enquanto a pessoa não tem acesso aos meios de proteção oferecidos pelo estado e nem acesso aos meios de proteção legais. É neste momento que entra o trabalho da quadrilha do COVID a nível operacional. \\

\noindent A quadrilha operacional do COVID agride a vítima de todas as formas possíveis. É um jogo covarde e pesado. \\ 

\noindent Os métodos de agreção são tão diversos quanto seria possível. Mas os objetivos são simples: confundir e exaurir psicologicamente a vítima, buscando silenciá-la ou fazer parecer que a pessoa tem problemas mentais. \\

\noindent Neste processo a vítima desenvolve uma série de quadros graves de sofrimentos psicológicos. Como poderia ser diferente ? Então é um processo auto alimentado. \\

\noindent Em uma visão otimista, o acédio irá cessar com o tempo. Mas olhando pelo lado mais realista, após anos sendo usada para levantamento de dados e outros experimentos, é possível que a vítima seja encontrada morta e o laudo médico será algo como alguma doença ou talvez suícidio. Tudo vai ficar por isso mesmo. Ninguém irá fazer nada. \\

\noindent Então seguindo... vamos exemplificar as formas de acédio ...  \\

exaustão: \\

\noindent Julho de 2024. Segunda feira, primeiro dia da semana, fim de uma longa greve. Retorno das atividades diárias de trabalho. Eu estou em casa, tentando ajustar as datas das realizações das atividades no sistema, e outros ajustes necessários do plano de aula. Consigo trabalhar um pouco, depois de reinicializar o modem várias vezes. \\

\noindent De repente, novamente a internet fica lenta. Não consigo fazer nada.

\noindent Entro no site de configurações do moden e vejo que a rede conectada da operadora CLARO é UMTS. Normalmente é 4G, mas tem mudado para UMTS com certa frequência. Normalmente eu resolvo isso reinicializando o modem. \\

\includegraphics[width=0.9\textwidth]{figures/net.jpg} \\

\noindent Tento reinicializar o modem. Faço isso inúmeras vezes. E a rede conectada continua sendo UMTS. \\

\noindent É claro que eu sei que algum desocupado está fazendo isso propositalmente. Apesar de não saber o motivo por trás disso. Será que é uma tentativa de rotear minha internet ? Ou será que é apenas para me chatear. Difícil saber. A única coisa clara é que, diante das circuntâncias, só pode ser algo provocado. \\

\noindent Ontem comecei a escrever o capítulo "O esquema". Então, era de se esperar que eu fosse ter algum tipo de chateação mais visível. \\

\noindent Escrever sobre tudo isso me deixa realmente angustiada, mas sem internet não posso trabalhar, então tento finalizar o capítulo O esquema. \\
