...
\noindent Looking from a global point of view, it is possible to see that Sun Tzu's teachings are also entailing discord and separation between countries that previously constituted a single nation. Examples include the war in Ukraine, the disagreements that are causing an intense rift between China and Taiwan, the conflicts in Gaza, and the conflicts in North and South America. \\

\noindent All this makes clear in my mind the idea that there is some bigger reason behind what is happening in Brazil and in the hole world.d
...
Will any non-governmental body, such as any association in defense of human rights, take the initiative to do something to prevent this ?
