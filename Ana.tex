...
\chapter{O Brasil está a beira de uma tentativa real e brutal de um novo golpe militar}

\noindent Eu acredito que qualquer ideia nasce com base em pelo menos seis fatores: identificação de uma questão, conhecimento teórico, experiência prática, capacidade criativa, e informações provindas do meio. \\

\noindent Qualquer nova idéia leva um certo tempo para se materializar, tempo este que pode ser demasiadamente longo, e também consome outro longo período de tempo para se tornar uma opinião. \\

\noindent O processo da materialização à tornar-se opinião é amparado pelo pensamento lógico e cognitivo. \\

\noindent O processo construtivo atrelado à cada informação lógica que afirma determinada idéia, tornam esta idéia mais persistente, até o ponto em que a idéia se torna uma opinião. \\

\noindent Pois tenho uma idéia que se torna mais persistente a cada dia. \\

\noindent \begin{center} \emph{O Brasil está a beira de uma tentativa real e brutal de um novo golpe militar.} \end{center}

\noindent Pois vou apenas começar a fazer uma prece a cada noite, agradecendo a deus (pelo que ?), e pedimento que Deus aos poucos me faça esquecer esta maldita idéia. \\

\noindent Bom... Também vou pedir a Deus que, a cada dia, haja cada vez mais motivos para agradecer. \\
 \\

\noindent \begin{center} \emph{Deus, pai eterno e todo poderoso, livrai-nos do mal. Amém.} \end{center}
