...
\chapter{Grupos na pesquisa}

\noindent \begin{center} \emph{Parece que o brasileiro nasce com um jeitinho... sempre existe um jeito de cortar o caminho ou de pular uma pedra ... há sempre um jeito para tudo.  } \end{center} 

\noindent Possivelmente é assim porque o povo brasileiro teve que sobreviver à varias crises... anos de inflação seguidos pela abertura da concorrência mundial no mercado e congelamento de poupanças junto com uma forte desvalorização monetária. \\

\noindent Eu era ainda uma criança, mas guardei na memroia o momento em que minha mãe colocou um bife frito no meu prato... após um longo período em que eu nem sabia mais o que era comer carne... no prato dela havia só arroz, feijão e um ovo frito. \\

\noindent Logo depois, vi as funcionárias de minha mãe estavam reclamando, dizendo que minha mãe estava comendo carne e não colocava carne no prato delas. \\

\noindent Froam inúmero momentos difíceis... mas em algumas regiões do Brasil, havia algo muito pior - a seca e a fome. No sertão brasileiro rebanhos inteiros de gado morriam sedentos e desnutridos. A tv mostrava periodicamente imagens de ossos e urubus em um cenário desértico que não parecia pertencer ao Brasil ... mas pertencia. \\

\noindent Após algumas tentavidas sem exito, o partido dos trabalhadores decidiu se reder à política da direita e assim pode, finalmente, chegar à presidência. Então... algo começou a mudar no Brasil. \\

\noindent Os professores universitários ganharam a chance de ter melhores salários, mas diplomas de mestrado e doutorado eram necessários. As universidades começaram a se espandir para cidades no interior brasileiro. Houveram muitos novos concursos, muitos novos cursos foram abertos e, em especial, muito programas de pós-graduação. Podemos dizer que o PT trouxe para o Brasil uma grande revolução universitária assim como direcionou o foco das universidades para a pesquisa. A CAPES se tornou responsável pela avaliação periódica dos programas de pós-graduação. \\

\noindent Após alguns anos, alguns grupos começaram a se fortalecer, e algumas universidades começaram a se tornar mais parecidas com instituições políticas do que propriamente autarquias. Alguns programas começaram a contratar (através de concurso) professores escolhidos a dedo e formados pelo próprio progama de pós-graduação, senão amigos e familiares, para aumetar o corpo docente de seus próprios grupos. E, para adiquirir melhor pontuação pela CAPES, os tempos de realização de mestrados e doutorados foram reduzidos. \\ 

\noindent Como resultado, programas de graduação e pós-graduação adiquiriram um corpo docente homogênio e com doutorado, mas sem a real capacidade de fazer pesquisa. \\

 \noindent Sem capacidade de criar seus próprios projetos, começa então a briga política pela propriedade da pesquisa alheia: se eu não posso desenvolver minha pesquisa, eu vou publicar a sua pesquisa. Então começa a retalhação política dentro das universidades aos professores que querem desenvolver um trabalho independente... a briga pela propriedade sobre o conhecimento. \\
 
 \noindent Certamente este é um problema que está agravado no Brasil. Possivelmente também é um problema agravado em outros paíseses, porque o evento de revolução da pesquisa aconteceu no Brasil, seguindo a uma tendência mundial. \\
 
 \noindent Contudo, eu acredito que ainda existe jeito para isso:
 
 \begin{itemize}
 \item despolitizar as universidades e os concursos de ingresso de professores (focando na multidisciplinaridade e crinado mecanismos e regulamentação para isso);
 \item identificar o real nível de conhecimento científico de mestres e doutores contratados na universidade;
 \item requalificar mestres e doutores já concursados, dando a estes a possibilidade de identificação de sua própria área de pesquisa, sendo a universidade responsável pela exigencia da pluralidade dos perfis profissionais;
 \item identificar a coerência dos temas dos trabalhos publicados com a área de conhecimento dos autores;
 \item exigir que a seção CRediT seja incluída em todas as publicações;
 \item exigir que os professores universitários tenham alguma formação em ética;
 \item criar mecanismos de apoio e suporte à todos os professores e não apenas aos grupos políticos das universidades;
 \item e, principalmente: desenvolver pesquisa aberta, com controle de versões (svn), de tal forma que as contribuições científicas e o progresso dos trabalhos em desenvolvimento possam se acompanhados de perto e por qualquer interessado.
 \end{itemize}
 
 \noindent Na maioria das universidades, assim como na maioria dos estados e dos condomínios, quem decide sempre decide para si mesmo... mas eu ainda tenho experança.
