...
\chapter{Industruia 5.0 - O novo futuro do trabalho}

Pensando sob o aspecto puramente capitalista, posso pensar em apenas um futuro possível. \\

Para que criar robôs, se é possível robotizar funcionários ? Afinal, isso irá certamente representar um maior custo benefício para muitas empresas ... não é mesmo ? \\

Eu imagino as empresas do futuro (5.0) como amplos espasços nos quais vagam máquinas e metahumanos (humanos robotizados), recebendo informações sobre a forma correta de proceder através de ships instalados no lobo frontal de seus cérebros. \\

Nosso guru Domênico pensou uma jornada reduzida de trabalho e bilhões de pessoas tendo mais tempo livre para viver melhor a vida ... uma grande civilização de Sócrates ... Seria bom ter nosso querido crítico ainda conosco. Publicando suas ideis futuristas.  \\

Eu só consigo visualizar uma populção reduzida, sem nenhuma vontade própria, dentro dos grandes galpões, trabalhando em torno de 18 horas por dia ... \\

\noindent \begin{center} \emph{Em um mundo neo capitalista, Sócrates seria visto como uma ameaça para a sociedade.} \end{center}
