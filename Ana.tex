...
\noindent E eu li artigos informando que nanotecnologias e BCI estavam sendo utilizados para "tratamento" de pessoas com disturbios mentais, tal como depressão. \\
...
\noindent Fourth. A questão não é só o levantamento de dados. \\

\noindent As novas tecnologias podem também ser usadas para simular uma epidemia ou mesmo uma pandemia. \\

\noindent Você pode questionar: mas... como ? \\

\noindent A resposta é realmente simples. Se existe tecnologia que pode ser implantada no cérebro para leitura de pensamentos, esta mesma tecnologia, ou outras de semelhante natureza, podem ser implantadas no organismo para causar dor e provocar sintomas de doenças. \\

\noindent Eu li um artigo que informa que os sintomas diagnosticados nos tempos de COVID são exatamente os mesmos sintomas causados pelo uso de nanomateriais quando absorvidos pelo organismo de diferentes formas. Outra pesquisa informa que inspirar alguns tipos de nanomaterias pode causar o mesmo efeito que inspirar amianto. O que poderia tranquilamente explicar sintomas semelhante a pneumonia. O uso de nanotecnologia em organismos humanos e animais também pode causar intoxicação, dor, mal estar, emtupimento de prótata e inflamações no cérebro e diversos tipos de câncer. \\

\noindent As novas tecnologias podem também ser usadas para a tortura e o silênciamento. As novas tecnologias podem também ser usadas para o terrorismo. \\

\noindent Acredite em mim ou não, tudo isso já está acontecendo. \\

\noindent Apesar de nunca em minha vida eu ter tido qualquer acompanhamento médico de um psiquiatrica. Apesar de eu não ter nenhum histórico de doenças mentais. Em janeiro de 2022, eu fui levada a força para o complexo Hospitalar Novo Nascer que fica no município de Camaragibe, no estado de Pernambuco, Brasil. \\

\noindent Para que pudessem justificar alguma doença mental, me deixaram assustada. Me aterrorizaram. \\

\noindent Havia uma psiquiatra com a qual eu conversei algumas poucas vezes dentro da clínica. Eu perguntei a esta psiquiatra o motivo de eu estar internada. Ela me disse que era por que eu estava estressada. Esta mesma médica entregou para minha família um atestado informando que eu estava fora da realidade, além de informar alguns indícios que poderiam talvez indicar algum transtorno mental. \\

\noindent O documento da clínica Novo Nascer, entregue para a minha família, apresenta uma mistura de poucas verdades com informações falsas, tentando figurar um caso de desvio mental. Ou seja, uma médica, com registro, aparentemente funcionária do Complexo Hospitalar Novo Nascer, elaborou um documento com informações falsas. \\

\noindent No entanto, no meu entendimento, a internação e o documento foram uma forma de destruir minha imagem e me silenciar. Não importa que eu trabalhe e page minhas contas. Não importa que eu seja uma pessoa independente. Não importa que eu seja doutora, cientista e professora. Não importa que eu esteja trabalhando com inovação cinetífica e que esteja publicando artigos cinetíficos e desenvolvendo um trabalho importante para formação de alunos e para o desenvolvimento de pequenas empresas. Independente do que eu venha a testemunhar, existe um documento de uma médica corrupta informando que eu estou fora da realidade e que possuo disturbios mentais. Então não importa se eu venha a procurar a polícia civil, a polícia federal, ou mesmo o ministério público. Porque a desculpa para ignorar qualquer coisa coisa que eu diga está em minha internação, no laudo falso elaborado por uma médica corrupta. Apesar de todos os crimes cometidos contra minha pessoa, no momento que me declaram sendo portadora de desvio mental, eu perco o acesso aos meus direitos civis e humanos. \\

\noindent Me torno vítima de ser objeto de pesquisa científica e tecnológica. Me torno vítima de terrorismo e de tortura. Me torno vítima de um sistema corrupto. Sem a possibilidade de pedir ajuda. Sem a possibilidade de buscar refúgio ou de tentar me defender. Eu me torno vítima do próprio sistema. Do próprio governo. Me torno vítima da própria sociedade. Ou, pelo menos, da parte da sociedade que é criminosa e corrupta. \\

\noindent Quando comecei a escrever Ana, eu tive a intenção de confrontar momentos de uma vida normal com os horrores de acontecimentos reais que são atuais. Eu tive a intenção de mostrar que atrás de um alvo sempre existe um ser humano. Mas Ana se tornou um grito de socorro. Um grito dizendo: Basta, não tem mais como aguentar essa merda toda !. Um grito dizendo: o planeta precisa de seres humanos melhores e mais humanos. Um grito dizendo que os direitos humanos precisam ser direitos de todos e precisam ser respeitados. \\

\noindent Ana em árabe significa Eu. Ana é a minha história. Ana é o meu testemunho sobre algo absurdo que não poderia ser realidade, mas que é uma das muitas realidades. Uma das muitas realidades que eu desejaria nunca ter conhecido. Um realidade da qual me tornei vítima. Uma realidade que precisa ser cessada. \\

\noindent A quadrilha do COVID é uma quadrilha. Há um grupo grande de pessoas que estão colaborando com isso. Mas há também um grupo por trás provocando e financiando as agressões. \\

\noindent Misturam algum produto na água e na comida. Acredito que possa ser algum produto que envolve nanotecnologia. A verdade é que pode ser qualquer coisa. De alguma forma, a quadrilha do COVID consegue introduzir a água e os produtos alterados na maioria dos lugares frequentados pela vítima. Não me pergunte como. Mas, certamente, a ameaça e a corrupção serve a isso. Eu vi coisas que se eu contasse, diriam que sou exquisofrênica. Certamente é possível provar. Mas minha posição não ajuda em nada. Testes caseiros com a água podem provar que a água está alterada. Por exemplo, a água se separa do produto que colocam na água fervendo e deixando descansar por alguns dias. Há testes de laboratório. O difícil é confiar em um laboratório, quando o próprio comércio está alterando a sua comida e bebida. E é ainda difícil achar um laboratório que analisa água. \\

\noindent Além da alteração da á agua, usam tecnologia para ler seus pensamentos e fazem questão de ter deixar ciente sobre isso, da forma mais agressiva possível. Se eu falar sobre isso com a polícia, também vou parecer esquisofrenia, eu sei. Mas estou escrevendo este texto para pessoas que entendem que isso é uma realidade. \\

\noindent A tecnologia também é usada para alterar seus vídeos, e qualquer material que você divulgue na internet. \\

\noindent A Gang do COVID enviada sua rede, desvia chamadas telefônicas, e sites visitados na internet, fazendo que seja impossível usar os meios formais para reclamação. \\

\noindent Quando a pessoa consegue realizar a denuncia, de alguma forma, após um esforço absurdo, conseguem modificar ou apagar a denuncia do sistema. \\

\noindent Acredito que a dor é provocada, inserindo no corpo algum produto de origem metálica ou coisa parecida. Acredito que Gang do COVID usa a rede elétrica ou coisa parecida para provocar dor na vítima. Ou talvez algum dispositivo instalado na residência da vítima ou local de trabalho, o qual pode ser acionado à média distância usando wifi ou bluetooth, ou sinal de rádio. Vai saber. \\

\noindent A Gang do COVID também estraga aparelhos eletrodomésticos. E, como eu disse antes, mesmo que o aparelho tenha sido comprado recentemente, é impossível concertar. Eu comprei uma geladeira nova da marca CONSUL que está apresentando defeitos a mais de uma ano. Eu não consigui resolver o problema, por mais que eu tenha tentado. O resfriamento da geladeira é assionado quando eu chego perto da geladeira. E também normalmente durante a noite - toda a noite. O resfriamento fica acionado durante horas seguidas. Às vezes liga e desliga. A geladeira faz outros barulhos estranho. Às vezes parece com o barulho da máquina de lavar quando esta está centrifugando a roupa. É, eu sei, parece coisas de um esquisofrênico. Mas posso dizer que eu já tive outras geladeiras e sei que não é assim que elas funcionam. \\

\noindent Bom, resumindo... a gang do COVID transforma a vida da vítima em um verdadeiro inferno... Os objetivos: destruir a imagem da vítima... agredir... adestrar... silênciar. \\

\noindent E eu tenho tido que suportar esta tortura desde de dezembro de 2021, quando as agressões se iniciaram. \\

\noindent De acordo com o que eu ouvi, outras pessoas começara a sofrer este mesmo tormento em 2020. \\
