...
\noindent The just moment I say this, it starts to rain abruptly and strongly. My mother asks: is you the one who is causing this rain ? Somewhat stunned by the question, I answer: of course not. My mother says: I will buy fruits for you with the Basco and then we go. \\
...
\noindent You really live far from the city, closer to the road. There has always been the noise of cars passing quickly through the road, as if it were the sound of the waves of the sea, and, besides, just the silence. But now you are constantly annoyed by a noise of cyrenes that pass on the road at reduced speed, and the sound of cars left in acute mode. Very loud sound of beats that resemble the sound of the heart. The COVID gang chooses to do this repeatedly at a standard moment of your day, which you usually do at different times. For example, the exact moment you decide to wet the plants. They want to make sure you understand that they are watching you. \\
...
\noindent COVID's gang is actually just a bunch of cowards. Someone who has a life dream of life would never spend his time assaulting or bothering other people. But all this is really almost unbearable. \\
...
\noindent Eu quase esqueci de relatar sobre os ataques tecnológicos. Assim como os ataques físicos e psicológicos há outros ataques que usam a rede e a coleta de seus dados. Nesta forma de ataque há também muita criatividade. Vamos tentar criar uma lista:

\emph{anúncios usando as propagandas do youtube}: você está vendo um filme no youtube no final do dia. Você se senta no sofá para conseguir se desligar das questões de um dia de trabalho e, de repente, aparece um anúncio com uma mensagem de morte, ou uma foto de alguma área da sua própria casa, ou de algum autor cujo livro você acabou de comprar, ou ainda alguma referência a algum pensamento seu recente, sobre o qual você não comentou com ninguém. \\

\emph{mensagens embutidas}: você começa a se chatear com o youtube e então assina o Netflix. Parece bom no começo, mas então você começa a receber e-mails de sites que você já consultou em algum momento da sua vida e nos quais você se inscreveu por algum motivo. Nestes e-mails há mensagens embutidas - uma frase grifada, ou simplesmente um texto que está fora do contexto. As frases também estão relacionadas aos seus pensamentos, ou há alguma coisa que você disse ou escreveu. São sempre comentários maliciosos, no sentido de provocação. Há também as mensagens de que aparecem no seu celular, do seu banco ou de sua operadora e de alguma fonte que normalmente você diria ser confiável. É claro, você pode até tentar conversar com um agente da polícia federal. Mas o que você vai dizer ? E ainda você terá que passar pelo atendente. Este último irá ter alguém ao lado delo, dizendo que ele deve descaratar ou colocar na geladeira. Este que aconselha aparentemente fala sobre comida. Mas o atendente vai dizer: eu não coloco nada na geladeira. E então encontra uma maneira de ter descartar rapidamente. O atendente diz algo como: a polícia federal não trata destes assuntos. \\
 
\emph{traduções do google translate}: você é acostumado a usar o google translate para o trabalho ou para traduzir o chat de um bom amigo, cuja lingua você ainda não conseguiu aprender. Então você cola a frase no tradutor e de repente aperece uma tradução: eu não sou responsável por isso, eu não sou químico. Você percebe que essa não uma possível expressão de seu amigo. Então você coloca o ponteiro logo após a ultima palavra e tecla ENTER novamente. E voilá, agora temos a mensagem de um amigo: eu também sinto a sua falta. Einda penso em conhecer o Brasil. 

\noindent São incontáveis formas... e é algo sobre o que não é agradável escrever... não é possível fazer referência a tudo... mas a forma em si aponta para os culpados... 

\noindent Primeiro: todo o acédio custa dinheiro. Dois anos de booling não custa barato. Quem poderia gastar tanto dinheiro com isso ? Um grande empresário, ou o que eu acredito - dinheiro público. Segundo: há pessoa envolvidas com um alto conhecimento em tecnologia. E,para ler os pensamentos de uma pessoa, é necessário ter acesso ao que existe de mais recente em termos de tecnologia. Terceiro: o gaslight e uma técnica que foi inventada por um psiquiatra. É um recurso maldoso que só pode ser idealizado e planejado por pessoas que tenham conhecimento em psiquiatria. \\

\noindent Tudo isso aliado ao roubo de suas ideias, aponta para uma direção única. Contudo, à quem recorrer para pedir ajuda ? E como usar o próprio testemunho quando sua própria mãe te internou em uma clínica e a psiquiatra da clínica te deu um atestado afirmando que você está fora da realidade ? Existe forma de sair deste inferno ? Se você sair, sua consciencia permitirá que você se silencie ? \\

\noindent De alguma forma o horror vai muito além do seu caminho, ele se disfarça e anda entre muitas pessoas. Você pode se silênciar quando você compreende que existe um sistema que abusa dos artifícios legais para enterrar viva uma pessoa que de alguma forma acabou se tornando um encômodo ? \\
